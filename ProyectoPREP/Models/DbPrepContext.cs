...
public partial class DbPrepContext : DbContext
{
    ...
    public virtual DbSet<VwPrepGestionUsuario> VwPrepGestionUsuarios { get; set; }

    public virtual DbSet<VwPrepPacientesElegibilidadNoSuspendidum> VwPrepPacientesElegibilidadNoSuspendida { get; set; }

    public virtual DbSet<VwPrepPacientesElegibilidadSuspendidum> VwPrepPacientesElegibilidadSuspendida { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=10.38.0.190,3342;Initial Catalog=DB_PREP; TrustServerCertificate=True;User Id=snsintranet;Password=Oblgg573uow4yZE8dt5L");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VwPrepGestionUsuario>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_Prep_Gestion_Usuarios");
        ...
        modelBuilder.Entity<VwPrepPacientesElegibilidadNoSuspendidum>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_Prep_Pacientes_Elegibilidad_NO_Suspendida");

            entity.Property(e => e.EstatusId).HasColumnName("Estatus_Id");
            entity.Property(e => e.FormularioPrepId).HasColumnName("Formulario_Prep_Id");
        });

        modelBuilder.Entity<VwPrepPacientesElegibilidadSuspendidum>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_Prep_Pacientes_Elegibilidad_Suspendida");
        ...
        modelBuilder.Entity<VwPrepPacientesSeguimientosUltimo>(entity =>
        {
            ...
            entity.Property(e => e.AsesoramientoRiesgos).HasColumnName("Asesoramiento_Riesgos");
            entity.Property(e => e.ConsultaSignosInfeccion).HasColumnName("Consulta_signos_infeccion");
            entity.Property(e => e.DiferenciaDias).HasColumnName("DIFERENCIA_DIAS");
            entity.Property(e => e.EfectosSecundarios).HasColumnName("Efectos_Secundarios");
            entity.Property(e => e.ElegibilidadPrepId).HasColumnName("Elegibilidad_Prep_Id");
            entity.Property(e => e.EntregaCondones).HasColumnName("Entrega_Condones");
            entity.Property(e => e.EstatusAutomatico).HasColumnName("ESTATUS_AUTOMATICO");
            entity.Property(e => e.EstatusDifSuspendido).HasColumnName("Estatus_Dif_Suspendido");
            entity.Property(e => e.EstatusSuspendido).HasColumnName("Estatus_Suspendido");
            entity.Property(e => e.FechaProximoSeguimiento).HasColumnType("datetime");
            entity.Property(e => e.FechaPruebaVih)
                .HasColumnType("datetime")
                .HasColumnName("Fecha_Prueba_VIH");
            ...
            entity.Property(e => e.ItsDiagnosticoPresuntivo).HasColumnName("ITS_Diagnostico_Presuntivo");
            entity.Property(e => e.MesesPrescripcion).HasColumnName("Meses_prescripcion");
            entity.Property(e => e.MesesPrescripcionDias).HasColumnName("Meses_prescripcion_Dias");
            entity.Property(e => e.MesesPrescripcionDiasVence).HasColumnName("Meses_prescripcion_Dias_Vence");
            entity.Property(e => e.NuevaItsdiagnosticada).HasColumnName("NuevaITSDiagnosticada");
            entity.Property(e => e.PrepArvTafFtc).HasColumnName("Prep_ARV_TAF_FTC");
            entity.Property(e => e.PrepArvTdf3tc).HasColumnName("Prep_ARV_TDF_3TC");
            entity.Property(e => e.PrepArvTdfFtc).HasColumnName("Prep_ARV_TDF_FTC");
